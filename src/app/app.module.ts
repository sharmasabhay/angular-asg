...
import {HttpRequestInterceptor} from './HttpRequestInterceptor';   // use this
...
@NgModule({
  ...
  providers: [CookieService, DatePipe, CategoryService, { provide: HTTP_INTERCEPTORS, useClass: HttpRequestInterceptor, multi: true }],
